...
export declare type MfmBlock = MfmQuote | MfmSearch | MfmImageSearch | MfmCodeBlock | MfmMathBlock | MfmCenter;
...
export declare type MfmImageSearch = {
    type: 'imageSearch';
    props: {
        query: string;
        content: string;
...
export declare const IMAGE_SEARCH: (query: string, content: string) => NodeType<'imageSearch'>;
...
export declare type MfmInline = MfmUnicodeEmoji | MfmEmojiCode | MfmBold | MfmSmall | MfmSmell | MfmItalic | MfmStrike | MfmInlineCode | MfmMathInline | MfmMention | MfmHashtag | MfmUrl | MfmLink | MfmFn | MfmText;
...
export declare type MfmSmell = {
    type: 'smell';
    props?: Record<string, unknown>;
    children: MfmInline[];
};
export declare const SMELL: (children: MfmInline[]) => NodeType<'smell'>;
